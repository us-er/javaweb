...
<!-- end::header menu -->
	...
	<div class="container-fluid">
		...
		<div class="card">
			<div class="card-body">
				<h5 class="card-title">博主账号添加</h5>
				<form action="/Blog/insertBlogger" method="post" enctype="multipart/form-data">
					<div class="form-group">
						<label for="exampleFormControlInput1">博客名</label>
						<input name="name" placeholder="请输入博客名" value="${blogger.name}"
							type="text" class="form-control" id="exampleFormControlInput1">
					</div>
					<div class="form-group">
						<label for="exampleFormControlInput1">密码</label> 
						<input name="password" placeholder="请输入博客密码" value="${blogger.password}"
							type="text" class="form-control" id="exampleFormControlInput1">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="exampleFormControlInput1">头像</label>
						<input name="file" placeholder="请输入博客密码" value="${blogger.password}"
